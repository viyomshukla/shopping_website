...
//-----------------------------------------------------------------------------------
string CityName[] = {"abc","agra", "mumbai", " delhi ", " kolkata ", "chennai", "noida", "gaziabad", "srinagar ", "ahemdabad","patna","lucknow"};

string A[]={"mumbai", "panvel", "juhu", "Defence", "lonavala", "thana"};

string I[]={"agra", "I-8" ,"A-14", "F-10", "F-7", "H-12"};

string K[]={"delhi", "Comsats Atd", "Rajiv chowk", "PC Hotel", "aiims Medical College", "india gate"};



int graph[V][V]={   {0, 4, 0, 0, 0, 0, 0, 0, 0, 0, 3},   //abc
					{4, 0, 0, 0, 0, 0, 0, 6, 0, 0, 2},	 //agra
					{0, 0, 0, 0, 9, 4, 0, 0, 0, 0, 11},	 //mumbai
					{0, 0, 0, 0, 1, 0, 0, 0, 16, 5, 0},	 //delhi
					{0, 0, 9, 1, 0, 8, 13, 0, 10, 6, 0}, //kolkata	
					{0, 0, 4, 0, 8, 0, 0, 3, 17, 0, 7},	 //chennai
					{0, 0, 0, 0, 13, 0, 0, 0, 0, 0, 7},	 //noida
					{0, 6, 0, 0, 0, 3, 0, 0, 5, 0, 0},	 //gaziabad
					{0, 0, 0, 16, 10, 17, 0, 5, 0, 0, 0},//Srinagar
                    {0, 0, 0, 5, 6, 0, 0, 0, 0, 0, 0},	 //ahmedabad
					{3, 2, 11, 0, 0, 7, 7, 0, 0, 0, 0}  };//patna
...
int main()
{
	...
	do
    {
        ...
        {                                               
            ...
            if(optionDelivery==1 || optionDelivery==2 || optionDelivery==3 )
			{
